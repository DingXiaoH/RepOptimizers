...
class RepOptimizerAdamW(Optimizer):
    ...
    Args:
        grad_mult_map (dict): output from a RepOptimizerHandler in the form of dict{param : mult}
    ...
    def __init__(self,
        ...
        super(RepOptimizerAdamW, self).__init__(params, defaults)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            adamw(params_with_grad,
                  ...
                  grad_mult_map=self.grad_mult_map)
...
def _single_tensor_adamw(params: List[Tensor],
    ...
    for i, param in enumerate(params):
        ...
        if param in grad_mult_map:
            update_mult = grad_mult_map[param]
        else:
            update_mult = 1
        ...
        if capturable:
            ...
            param.addcdiv_(exp_avg * update_mult, denom)
        else:
            step = step_t.item()
            ...
            param.addcdiv_(exp_avg * update_mult, denom, value=-step_size)



#   Note: I did not test this part since I never used "foreach". Only added three lines of code related to "mults"
def _multi_tensor_adamw(params: List[Tensor],
    ...
    mults = [grad_mult_map[x] if x in grad_mult_map else torch.ones_like(x).to(x.device) for x in params]   # not tested
    ...
    if capturable:
        ...
        torch._foreach_mul_(exp_avgs, mults)    # not tested
